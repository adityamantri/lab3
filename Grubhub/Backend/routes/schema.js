...
mongoose.connect('mongodb+srv://root:root@cluster1-9j3qi.mongodb.net/mydb?retryWrites=true&w=majority', { useUnifiedTopology:true, useNewUrlParser: true });
...
var restownerModel = mongoose.model('restowners', restownerSchema, 'restowners');
